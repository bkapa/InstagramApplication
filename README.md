# Project 1 - InstagramApp

InstagramApp is an android app that allows a user to check out popular photos from Instagram. The app utilizes Instagram API to display images and basic image information to the user.
...
<img src='android_instagramApp.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
